    ...
    <nav className="w-full bg-white border-b border-gray-100 px-8 py-4">
      <div className="max-w-6xl mx-auto flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          ...
          <a
            href="#"
            className="hidden lg:block font-medium text-gray-600 hover:text-violet-600"
          >
            Login
          </a>
          <button className="hidden lg:block font-semibold text-white px-5 py-2 rounded-full bg-linear-to-b from-[#4F39F6] to-[#9514FA] hover:opacity-90 transition-opacity duration-200">
            Get Started
          </button>
